        ...
        <div className="max-w-3xl mx-auto">
          <form className="space-y-6">
            ...
            <div className="text-center">
              ...
              >
                发送消息
                <svg className="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style={{ maxWidth: '20px', maxHeight: '20px' }}>
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 bg-blue-600 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style={{ maxWidth: '32px', maxHeight: '32px' }}>
